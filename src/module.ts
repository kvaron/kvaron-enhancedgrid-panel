...
export const plugin = new PanelPlugin<EnhancedGridOptions, EnhancedGridFieldConfig>(
  EnhancedGridPanel
)
  ...
  .setPanelOptions((builder) => {
    return builder
      ...
      .addBooleanSwitch({
        ...
        description: 'Automatically size ALL columns to fit their content (ignores per-column settings). Columns with explicit widths are exempt.',
        defaultValue: false,
        category: ['Display'],
      })
      .addNumberInput({
      ...
      .addTextInput({
        ...
        description: 'Dashboard variable name for filter query only (e.g., "gridFilter"). Pagination uses separate variables below.',
      ...
      .addTextInput({
        ...
        description: 'Dashboard variable name for sort query only (e.g., "gridSort"). Pagination uses separate variables below.',
